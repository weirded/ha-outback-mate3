...
def create_device_entities(mate3: OutbackMate3, remote_ip: str, device_type: int, device_id: int) -> List[SensorEntity]:
    ...
    if device_type == 6:  # Inverter
        ...
        entities.extend([
            OutbackInverterSensor(mate3, remote_ip, device_id, "l1_inverter_current", "L1 Inverter Current",
                                SensorDeviceClass.CURRENT, UnitOfElectricCurrent.AMPERE),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l1_charger_current", "L1 Charger Current",
                                SensorDeviceClass.CURRENT, UnitOfElectricCurrent.AMPERE),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l1_buy_current", "L1 Buy Current",
                                SensorDeviceClass.CURRENT, UnitOfElectricCurrent.AMPERE),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l1_sell_current", "L1 Sell Current",
                                SensorDeviceClass.CURRENT, UnitOfElectricCurrent.AMPERE),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l1_ac_input_voltage", "L1 AC Input Voltage",
                                SensorDeviceClass.VOLTAGE, UnitOfElectricPotential.VOLT),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l1_ac_output_voltage", "L1 AC Output Voltage",
                                SensorDeviceClass.VOLTAGE, UnitOfElectricPotential.VOLT),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l2_inverter_current", "L2 Inverter Current",
                                SensorDeviceClass.CURRENT, UnitOfElectricCurrent.AMPERE),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l2_charger_current", "L2 Charger Current",
                                SensorDeviceClass.CURRENT, UnitOfElectricCurrent.AMPERE),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l2_buy_current", "L2 Buy Current",
                                SensorDeviceClass.CURRENT, UnitOfElectricCurrent.AMPERE),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l2_sell_current", "L2 Sell Current",
                                SensorDeviceClass.CURRENT, UnitOfElectricCurrent.AMPERE),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l2_ac_input_voltage", "L2 AC Input Voltage",
                                SensorDeviceClass.VOLTAGE, UnitOfElectricPotential.VOLT),
            OutbackInverterSensor(mate3, remote_ip, device_id, "l2_ac_output_voltage", "L2 AC Output Voltage",
                                SensorDeviceClass.VOLTAGE, UnitOfElectricPotential.VOLT),
            OutbackInverterSensor(mate3, remote_ip, device_id, "output_power", "Output Power",
