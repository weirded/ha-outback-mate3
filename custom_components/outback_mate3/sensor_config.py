"""Config-derived diagnostic sensors for the Outback MATE3 integration.

All 400+ entities here come from the add-on's periodic HTTP poll of
``http://<mate3>/CONFIG.xml`` (firmware, nameplate, setpoints, AGS /
Grid_Use / HVT / LVC / SunSpec / etc.). They're factored out of
``sensor.py`` to keep that file focused on the UDP live-data path, and
are all registered as ``EntityCategory.DIAGNOSTIC`` and
``entity_registry_enabled_default=False`` — the recorder stays quiet
and users opt in only to the ones they care about.
"""
    ...
    def __init__(
        ...
        *,
        ...
        if device_kind == "system":
            ...
            self.entity_id = f"sensor.mate3_{mac_id}_{device_kind}_{device_id}_{key}"
            self._attr_unique_id = f"{DOMAIN}_{mac_address}_{device_kind}_{device_id}_{key}"
            device_info = DeviceInfo(
...
_SYSTEM_CONFIG_SENSORS = [
    ...
    (
        "nominal_voltage",
        "Nominal Voltage",
        _sys("nominal_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    ("battery_ah_capacity", "Battery Ah Capacity", _sys("battery_ah_capacity"), "Ah", None, False),
    (
        "pv_size_watts",
        "PV Size",
        _sys("pv_size_watts"),
    ...
    (
        "max_inverter_output_kw",
        "Max Inverter Output",
        _sys("max_inverter_output_kw"),
        "kW",
        None,
        False,
    ),
    (
        "max_charger_output_kw",
        "Max Charger Output",
        _sys("max_charger_output_kw"),
        "kW",
        None,
        False,
    ),
    ...
    (
        ...
        "Low SOC Warning",
        _m3("low_soc_warning_percentage"),
        "%",
        None,
        False,
    ),
    ...
    # Coordination
    (
        "cc_float_coordination_mode",
        "CC Float Coordination",
        _m3("cc_float_coordination_mode"),
        None,
        None,
        False,
    ),
    (
        "multi_phase_coordination_mode",
        "Multi-Phase Coordination",
        _m3("multi_phase_coordination_mode"),
        None,
        None,
        False,
    ),
    # AC coupling
    (
        "ac_coupled_control_mode",
        "AC Coupled Control",
        _m3("ac_coupled_control_mode"),
        None,
        None,
        False,
    ),
    (
        "ac_coupled_control_aux_output",
        "AC Coupled AUX Output",
        _m3("ac_coupled_control_aux_output"),
        None,
        None,
        False,
    ),
    ...
    (
        "global_cc_control_mode",
        "Global CC Output Control",
        _m3("global_cc_control_mode"),
        None,
        None,
        False,
    ),
    (
        "global_cc_max_charge_rate",
        "Global CC Max Charge Rate",
    ...
    # FNDC
    (
        "fndc_charge_term_mode",
        "FNDC Charge Term Control",
        _m3("fndc_charge_term_mode"),
        None,
        None,
        False,
    ),
    ...
    (
        "grid_mode_schedule_1_mode",
        "Grid Mode Schedule 1",
        _m3("grid_mode_schedule_1_mode"),
        None,
        None,
        False,
    ),
    (
        "grid_mode_schedule_1_enable_hour",
        "Grid Mode Schedule 1 Hour",
        _m3("grid_mode_schedule_1_enable_hour"),
        None,
        None,
        False,
    ),
    (
        "grid_mode_schedule_1_enable_min",
        "Grid Mode Schedule 1 Minute",
        _m3("grid_mode_schedule_1_enable_min"),
        None,
        None,
        False,
    ),
    (
        "grid_mode_schedule_2_mode",
        "Grid Mode Schedule 2",
        _m3("grid_mode_schedule_2_mode"),
        None,
        None,
        False,
    ),
    (
        "grid_mode_schedule_2_enable_hour",
        "Grid Mode Schedule 2 Hour",
        _m3("grid_mode_schedule_2_enable_hour"),
        None,
        None,
        False,
    ),
    (
        "grid_mode_schedule_2_enable_min",
        "Grid Mode Schedule 2 Minute",
        _m3("grid_mode_schedule_2_enable_min"),
        None,
        None,
        False,
    ),
    (
        "grid_mode_schedule_3_mode",
        "Grid Mode Schedule 3",
        _m3("grid_mode_schedule_3_mode"),
        None,
        None,
        False,
    ),
    (
        "grid_mode_schedule_3_enable_hour",
        "Grid Mode Schedule 3 Hour",
        _m3("grid_mode_schedule_3_enable_hour"),
        None,
        None,
        False,
    ),
    (
        "grid_mode_schedule_3_enable_min",
        "Grid Mode Schedule 3 Minute",
        _m3("grid_mode_schedule_3_enable_min"),
        None,
        None,
        False,
    ),
    ...
    (
        "hvt_disconnect_voltage",
        "HVT Disconnect Voltage",
        _m3("hvt_disconnect_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    (
        "hvt_disconnect_delay",
        "HVT Disconnect Delay",
        _m3("hvt_disconnect_delay"),
        None,
        None,
        False,
    ),
    (
        "hvt_reconnect_voltage",
        "HVT Reconnect Voltage",
        _m3("hvt_reconnect_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    ...
    (
        "hvt_soc_disconnect_pct",
        "HVT Disconnect SOC",
        _m3("hvt_soc_disconnect_pct"),
        "%",
        None,
        False,
    ),
    ...
    (
        "lgt_load_threshold_kw",
        "Load-Grid Threshold",
        _m3("lgt_load_threshold_kw"),
        "kW",
        None,
        False,
    ),
    ...
    (
        "lgt_disconnect_delay",
        "Load-Grid Disconnect Delay",
        _m3("lgt_disconnect_delay"),
        None,
        None,
        False,
    ),
    (
        "lgt_low_battery_connect_voltage",
        "Load-Grid Low Battery Connect",
    ...
    (
        "lgt_high_battery_disconnect_voltage",
        "Load-Grid High Battery Disconnect",
    ...
    (
        "ags_ac_input_reconnect_delay",
        "AGS AC Input Reconnect Delay",
        _m3("ags_ac_input_reconnect_delay"),
        None,
        None,
        False,
    ),
    (
        "ags_dc_generator_absorb_time",
        "AGS DC Generator Absorb Time",
        _m3("ags_dc_generator_absorb_time"),
        None,
        None,
        False,
    ),
    (
        "ags_dc_generator_absorb_voltage",
        "AGS DC Generator Absorb Voltage",
    ...
    (
        "ags_fndc_full_charge_mode",
        "AGS FNDC Full Charge",
        _m3("ags_fndc_full_charge_mode"),
        None,
        None,
        False,
    ),
    (
        "ags_fndc_full_charge_interval",
        "AGS FNDC Full Charge Interval",
        _m3("ags_fndc_full_charge_interval"),
        "d",
        None,
        False,
    ),
    # Generator Exercise
    (
        "ags_generator_exercise_mode",
        "AGS Generator Exercise",
        _m3("ags_generator_exercise_mode"),
        None,
        None,
        False,
    ),
    (
        "ags_generator_exercise_day",
        "AGS Generator Exercise Day",
        _m3("ags_generator_exercise_day"),
        None,
        None,
        False,
    ),
    (
        "ags_generator_exercise_interval",
        "AGS Generator Exercise Interval",
        _m3("ags_generator_exercise_interval"),
        None,
        None,
        False,
    ),
    (
        "ags_generator_exercise_period",
        "AGS Generator Exercise Period",
        _m3("ags_generator_exercise_period"),
        None,
        None,
        False,
    ),
    (
        "ags_generator_exercise_sell_during",
        "AGS Sell During Exercise",
        _m3("ags_generator_exercise_sell_during"),
        None,
        None,
        False,
    ),
    (
        "ags_generator_exercise_start_hour",
        "AGS Generator Exercise Start Hour",
        _m3("ags_generator_exercise_start_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_generator_exercise_start_min",
        "AGS Generator Exercise Start Min",
        _m3("ags_generator_exercise_start_min"),
        None,
        None,
        False,
    ),
    ...
    (
        "ags_load_start_start_delay",
        "AGS Load Start Start Delay",
        _m3("ags_load_start_start_delay"),
        None,
        None,
        False,
    ),
    (
        "ags_load_start_start_load_kw",
        "AGS Load Start Start Load",
        _m3("ags_load_start_start_load_kw"),
        "kW",
        None,
        False,
    ),
    (
        "ags_load_start_stop_delay",
        "AGS Load Start Stop Delay",
        _m3("ags_load_start_stop_delay"),
        None,
        None,
        False,
    ),
    (
        "ags_load_start_stop_load_kw",
        "AGS Load Start Stop Load",
        _m3("ags_load_start_stop_load_kw"),
        "kW",
        None,
        False,
    ),
    ...
    (
        "ags_must_run_weekday_start_hour",
        "AGS Must Run Weekday Start Hour",
        _m3("ags_must_run_weekday_start_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_must_run_weekday_start_min",
        "AGS Must Run Weekday Start Min",
        _m3("ags_must_run_weekday_start_min"),
        None,
        None,
        False,
    ),
    (
        "ags_must_run_weekday_stop_hour",
        "AGS Must Run Weekday Stop Hour",
        _m3("ags_must_run_weekday_stop_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_must_run_weekday_stop_min",
        "AGS Must Run Weekday Stop Min",
        _m3("ags_must_run_weekday_stop_min"),
        None,
        None,
        False,
    ),
    (
        "ags_must_run_weekend_start_hour",
        "AGS Must Run Weekend Start Hour",
        _m3("ags_must_run_weekend_start_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_must_run_weekend_start_min",
        "AGS Must Run Weekend Start Min",
        _m3("ags_must_run_weekend_start_min"),
        None,
        None,
        False,
    ),
    (
        "ags_must_run_weekend_stop_hour",
        "AGS Must Run Weekend Stop Hour",
        _m3("ags_must_run_weekend_stop_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_must_run_weekend_stop_min",
        "AGS Must Run Weekend Stop Min",
        _m3("ags_must_run_weekend_stop_min"),
        None,
        None,
        False,
    ),
    ...
    (
        "ags_quiet_time_weekday_start_hour",
        "AGS Quiet Time Weekday Start Hour",
        _m3("ags_quiet_time_weekday_start_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_quiet_time_weekday_start_min",
        "AGS Quiet Time Weekday Start Min",
        _m3("ags_quiet_time_weekday_start_min"),
        None,
        None,
        False,
    ),
    (
        "ags_quiet_time_weekday_stop_hour",
        "AGS Quiet Time Weekday Stop Hour",
        _m3("ags_quiet_time_weekday_stop_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_quiet_time_weekday_stop_min",
        "AGS Quiet Time Weekday Stop Min",
        _m3("ags_quiet_time_weekday_stop_min"),
        None,
        None,
        False,
    ),
    (
        "ags_quiet_time_weekend_start_hour",
        "AGS Quiet Time Weekend Start Hour",
        _m3("ags_quiet_time_weekend_start_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_quiet_time_weekend_start_min",
        "AGS Quiet Time Weekend Start Min",
        _m3("ags_quiet_time_weekend_start_min"),
        None,
        None,
        False,
    ),
    (
        "ags_quiet_time_weekend_stop_hour",
        "AGS Quiet Time Weekend Stop Hour",
        _m3("ags_quiet_time_weekend_stop_hour"),
        None,
        None,
        False,
    ),
    (
        "ags_quiet_time_weekend_stop_min",
        "AGS Quiet Time Weekend Stop Min",
        _m3("ags_quiet_time_weekend_stop_min"),
        None,
        None,
        False,
    ),
    ...
    (
        "ags_soc_start_start_percentage",
        "AGS SOC Start %",
        _m3("ags_soc_start_start_percentage"),
        "%",
        None,
        False,
    ),
    (
        "ags_soc_start_stop_percentage",
        "AGS SOC Stop %",
        _m3("ags_soc_start_stop_percentage"),
        "%",
        None,
        False,
    ),
    # Voltage starts
    (
        "ags_two_min_voltage_start_mode",
        "AGS 2-Min Voltage Start",
        _m3("ags_two_min_voltage_start_mode"),
        None,
        None,
        False,
    ),
    (
        "ags_two_min_voltage_start_voltage",
        "AGS 2-Min Voltage",
    ...
    (
        "ags_two_hour_voltage_start_mode",
        "AGS 2-Hour Voltage Start",
        _m3("ags_two_hour_voltage_start_mode"),
        None,
        None,
        False,
    ),
    (
        "ags_two_hour_voltage_start_voltage",
        "AGS 2-Hour Voltage",
    ...
    (
        "ags_twenty_four_hour_voltage_start_mode",
        "AGS 24-Hour Voltage Start",
        _m3("ags_twenty_four_hour_voltage_start_mode"),
        None,
        None,
        False,
    ),
    (
        "ags_twenty_four_hour_voltage_start_voltage",
        "AGS 24-Hour Voltage",
...
for _prefix, _label in [
    ("grid_use", "Grid Use"),
    ("grid_use_p2", "Grid Use P2"),
    ("grid_use_p3", "Grid Use P3"),
]:
    ...
    for _day in ("weekday", "weekend"):
        for _stage in ("drop", "use"):
            for _unit, _unit_label in [("hour", "Hour"), ("min", "Min")]:
                ...
                _SYSTEM_CONFIG_SENSORS.append((_key, _name, _m3(_key), None, None, False))
...
_INVERTER_CONFIG_SENSORS = [
    ...
    (
        "configured_inverter_mode",
        "Configured Inverter Mode",
        _inv("inverter_mode"),
        None,
        None,
        False,
    ...
    (
        "ac_output_voltage",
        "AC Output Voltage Setpoint",
        _inv("ac_output_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    (
        "low_battery_cut_out_voltage",
        "Low Battery Cut-Out",
        _inv("low_battery_cut_out_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    (
        "low_battery_cut_in_voltage",
        "Low Battery Cut-In",
        _inv("low_battery_cut_in_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    (
        "high_battery_cut_out_voltage",
        "High Battery Cut-Out",
        _inv("high_battery_cut_out_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    (
        "high_battery_cut_in_voltage",
        "High Battery Cut-In",
        _inv("high_battery_cut_in_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    ...
    (
        "charger_absorb_voltage",
        "Charger Absorb Voltage",
        _inv("charger_absorb_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    ...
    (
        "charger_eq_voltage",
        "Charger EQ Voltage",
        _inv("charger_eq_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    (
        "charger_re_float_voltage",
        "Charger Re-Float Voltage",
        _inv("charger_re_float_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    (
        "charger_re_bulk_voltage",
        "Charger Re-Bulk Voltage",
        _inv("charger_re_bulk_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    ...
    (
        "stack_master_power_save_level",
        "Stack Master Power-Save Level",
        _inv("stack_master_power_save_level"),
        None,
        None,
        False,
    ),
    (
        "stack_slave_power_save_level",
        "Stack Slave Power-Save Level",
        _inv("stack_slave_power_save_level"),
        None,
        None,
        False,
    ),
    ...
    (
        "search_ac_load_threshold_amps",
        "Search AC Load Threshold",
    ...
    (
        "search_pulse_spacing",
        "Search Pulse Spacing",
        _inv("search_pulse_spacing"),
        None,
        None,
        False,
    ),
    ...
    # --- Mini Grid / Grid Zero ---
    (
        "mini_grid_lbx_voltage",
        "Mini-Grid LBX Voltage",
        _inv("mini_grid_lbx_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    ...
    (
        "grid_zero_voltage",
        "Grid Zero Min Voltage",
        _inv("grid_zero_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    ...
    (
        "aux_output_operation_mode",
        "AUX Operation Mode",
        _inv("aux_output_operation_mode"),
        None,
        None,
        False,
    ),
    ...
    (
        "aux_output_high_setpoint_voltage",
        "AUX High Setpoint Voltage",
    ...
    (
        "aux_output_low_setpoint_voltage",
        "AUX Low Setpoint Voltage",
    ...
    (
        "aux_output_high_setpoint_ac_amps",
        "AUX High Setpoint AC Amps",
    ...
    (
        "aux_output_low_setpoint_ac_amps",
        "AUX Low Setpoint AC Amps",
    ...
    (
        "relay_operation_mode",
        "Relay Operation Mode",
        _inv("relay_operation_mode"),
        None,
        None,
        False,
    ),
    ...
    (
        "relay_high_setpoint_voltage",
        "Relay High Setpoint Voltage",
    ...
    (
        "relay_low_setpoint_voltage",
        "Relay Low Setpoint Voltage",
    ...
    (
        "relay_high_setpoint_ac_amps",
        "Relay High Setpoint AC Amps",
    ...
    (
        "relay_low_setpoint_ac_amps",
        "Relay Low Setpoint AC Amps",
...
_CC_CONFIG_SENSORS = [
    ...
    (
        "charger_absorb_end_amps",
        "Absorb End Amps",
        _cc("charger_absorb_end_amps"),
        UnitOfElectricCurrent.AMPERE,
        SensorDeviceClass.CURRENT,
        False,
    ),
    ...
    (
        "charger_output_limit",
        "Output Current Limit",
        _cc("charger_output_limit"),
        UnitOfElectricCurrent.AMPERE,
        SensorDeviceClass.CURRENT,
        False,
    ),
    ...
    # --- Charger extras ---
    (
        "charger_eq_auto_interval_days",
        "EQ Auto Interval",
        _cc("charger_eq_auto_interval_days"),
        "d",
        None,
        False,
    ),
    ...
    (
        "aux_error_low_batt_voltage",
        "AUX Error Low Battery Voltage",
    ...
    (
        "aux_low_batt_disconnect_voltage",
        "AUX Low-Batt Disconnect Voltage",
    ...
    (
        "aux_low_batt_disconnect_delay",
        "AUX Low-Batt Disconnect Delay",
        _cc("aux_low_batt_disconnect_delay"),
        None,
        None,
        False,
    ),
    (
        "aux_low_batt_reconnect_voltage",
        "AUX Low-Batt Reconnect Voltage",
    ...
    (
        "aux_vent_fan_voltage",
        "AUX Vent Fan Voltage",
        _cc("aux_vent_fan_voltage"),
        UnitOfElectricPotential.VOLT,
        SensorDeviceClass.VOLTAGE,
        False,
    ),
    (
        "aux_diversion_hold_time",
        "AUX Diversion Hold Time",
        _cc("aux_diversion_hold_time"),
        None,
        None,
        False,
    ),
    ("aux_diversion_delay", "AUX Diversion Delay", _cc("aux_diversion_delay"), None, None, False),
    (
        "aux_diversion_relative_voltage",
        "AUX Diversion Relative Voltage",
    ...
    (
        "aux_diversion_hysteresis_voltage",
        "AUX Diversion Hysteresis Voltage",
    ...
    (
        "aux_pv_trigger_voltage",
        "AUX PV Trigger Voltage",
    ...
    (
        "aux_pv_trigger_hold_time",
        "AUX PV Trigger Hold Time",
        _cc("aux_pv_trigger_hold_time"),
        None,
        None,
        False,
    ),
    (
        "aux_nite_light_threshold_voltage",
        "AUX Nite Light Threshold Voltage",
    ...
    (
        "aux_nite_light_on_hyst_time",
        "AUX Nite Light On Hyst Time",
        _cc("aux_nite_light_on_hyst_time"),
        None,
        None,
        False,
    ),
    (
        "aux_nite_light_off_hyst_time",
        "AUX Nite Light Off Hyst Time",
        _cc("aux_nite_light_off_hyst_time"),
        None,
        None,
        False,
    ),
    (
        "aux_nite_light_on_hours",
        "AUX Nite Light On Hours",
        _cc("aux_nite_light_on_hours"),
        "h",
        None,
        False,
    ),
